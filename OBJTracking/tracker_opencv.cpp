...
{
	Stream_Sender = new CStreamCommunication("225.1.1.4",9191);
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	else if(m_param.method == CAMSHIFT)
	{
		if(m_rc.width>0 && m_rc.height>0)
		{
			...
			int objPosX=0, objPosY=0;
			trackBox.center.x = objPosX;
			trackBox.center.y = objPosY;
			Stream_Sender->Send("test");
	//		int sign,dec;
			//Stream_Sender->Send(fcvt( trackBox.center.x, 7, &dec, &sign));
